...
{	
	$image = $_GET["imgfile"];
	if (isset($_GET["max_width"])) { if($_GET["max_width"] < 2000) $max_width = intval($_GET["max_width"]); }
	if (isset($_GET["max_height"])) { if($_GET["max_height"] < 1000) $max_height = intval($_GET["max_height"]); }
	...
	$thumbModified = (file_exists($resized)) ? filemtime($resized) : 0;
